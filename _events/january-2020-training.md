...
<a href="{{ site.url }}/#donate" target="_blank"><button class="large" id="pp-donate" type="submit" name="submit" style="margin-top:12px;" ontouchstart="">Donate to IWW NYC</button></a>
